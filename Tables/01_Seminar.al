table 123456701 "CSD Seminar"
{
            ...
            begin
                if(xRec."Gen. Prod. Posting Group" <>
                 "Gen. Prod. Posting Group") then begin
                    if GenProdPostingGruop.ValidateVatProdPostingGroup
                    (GenProdPostingGruop, "Gen. Prod. Posting Group") then
                        Validate("VAT Prod. Posting Group",
                    GenProdPostingGruop."Def. VAT Prod. Posting Group");
                end;
            end;
        }
    ...
    var
        ...
        GenProdPostingGruop: Record "Gen. Product Posting Group";
